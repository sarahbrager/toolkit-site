...
Now you should see all three datasets inside your data-raw folder when you click on it. To exit out of the folder, click on the two little dots next to the green arrow.

### Recap

In this section, you learned how to download data from LegiScan and view the files on your computer.

Next, you're going to start coding!
